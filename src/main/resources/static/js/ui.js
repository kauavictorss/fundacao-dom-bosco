...
export function updateGlobalSearchDatalist() {
    ...
    // const currentUser = getCurrentUser(); // A variável não é mais usada aqui

    // TODO: A lógica abaixo precisa ser substituída por chamadas à API para popular a busca.
    console.warn('A função de busca global (updateGlobalSearchDatalist) precisa ser conectada à API.');
